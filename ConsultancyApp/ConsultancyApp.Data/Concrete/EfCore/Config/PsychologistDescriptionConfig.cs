...
namespace ConsultancyApp.Data.Concrete.EfCore.Config
{
    public class PsychologistDescriptionConfig : IEntityTypeConfiguration<PsychologistDescription>
    {
        ...
        {
            builder.HasKey(x => x.Id); //PrimaryKey olmasını sağlandı.
